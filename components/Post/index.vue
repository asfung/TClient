  ...
  <div class="border border-black">
    <div class="flex">
      ...
      <div class="flex-1 px-2 pt-2 mt-2">
        ...
        <div class="flex">
          ...
          <div class="flex-1">
            <button class="bg-blue-400 mt-5 hover:bg-blue-600 text-white font-bold py-2 px-8 rounded-full mr-8 float-right">Tweet</button>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="flex items-center">
          ...
          <div class="ml-3">
            <p class="text-base leading-6 font-medium">
              Sonali Hirave
              <span class="text-sm leading-5 font-medium text-gray-400 group-hover:text-gray-300 transition ease-in-out duration-150"> @ShonaDesign . 16 April </span>
            </p>
          </div>
        </div>
      </a>
    ...
    <div class="pl-16">
      <p class="text-base width-auto font-medium flex-shrink">
        Day 07 of the challenge <span class="text-blue-400">#100DaysOfCode</span> I was wondering what I can do with <span class="text-blue-400">#tailwindcss</span>, so just started building Twitter UI using Tailwind and so far it looks so
      ...
      <div class="flex">
        <div class="w-full">
          <div class="flex items-center">
            ...
            <div class="flex-1 text-center py-2 m-2">
              <a href="#" class="w-12 mt-1 group flex items-center text-gray-500 px-3 py-2 text-base leading-6 font-medium rounded-full hover:bg-green-500 hover:text-green-300">
                <svg class="text-center h-7 w-6" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div v-for="(item, index) in feeds" :key="index">
      ...
      <div class="pl-16">
        <p class="text-base width-auto font-medium flex-shrink">
          Day 07 of the challenge <span class="text-blue-400">#100DaysOfCode</span> I was wondering what I can do with <span class="text-blue-400">#tailwindcss</span>, so just started building Twitter UI using Tailwind and so far it looks
