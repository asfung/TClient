<template>
    ...
    <div class="header dark:bg-black dark:text-white bg-gray-100 text-gray-900 shadow-md py-4 px-6 flex justify-between backdrop-blur-md bg-opacity-20 dark:backdrop-blur-sm dark:bg-opacity-50">

        <!-- <h1>Talker</h1> -->
        <h1>Header</h1>

        <button class="" @click="setColorTheme($colorMode.preference === 'dark' ? 'light' : 'dark')">
          <svg 
